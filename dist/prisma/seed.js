...
function seed() {
    return __awaiter(this, void 0, void 0, function () {
        var testToken, secondtestToken, user, application, secondUser, secondApplication;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, testUtils_1.generateJWTForTest)()];
                case 1:
                    testToken = _a.sent();
                    return [4 /*yield*/, (0, testUtils_1.createSecondUser)()];
                case 2:
                    secondtestToken = _a.sent();
